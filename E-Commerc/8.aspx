<%@ Page Language="C#" AutoEventWireup="true" CodeFile="8.aspx.cs" Inherits="men" MasterPageFile="~/MasterPage.master" %>
...
<asp:Content ID="content2" ContentPlaceHolderID="contentPlaceholder2" runat="server">
     <asp:Repeater ID="rptmencat" runat="server">
                ...
                <div class="thumbnail">
                    <div class="">
                        <a>                    <img src='<%# Eval("image")%>'  alt="Image of product" class="imag "></a>
